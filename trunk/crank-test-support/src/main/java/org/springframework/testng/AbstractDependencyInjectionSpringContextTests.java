...
//This class donated by Rob Williams.
package org.springframework.testng;
...
public abstract class AbstractDependencyInjectionSpringContextTests extends AbstractSpringContextTests {
	...
	@org.testng.annotations.Configuration(beforeTestClass = true, groups = { "SpringContext" })
	...
	protected void initManagedVariableNames() throws IllegalAccessException {
		...
		do {
			...
			for (int i = 0; i < fields.length; i++) {
				// go up tree but not to this class, I have no idea what this means anymore... Rick Hightower
