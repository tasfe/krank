...
public class TagControllerTest extends SpringTestNGBase {
...
//	private Map<String, JsfCrudAdapter<Employee, Long>> cruds;
	...
	public void testInitsProperly() {
		...
		assertNotNull("We have the selected tags list", tagController.getSelectedTags());
		assertEquals("No tags have been selected yet", 0, tagController.getSelectedTags().size());
	}
	@SuppressWarnings("unchecked")
	...
	public void testNormalCase() {
		...
		assertTrue(CollectionUtils.valueExists ("name", "one",  tagController.getSelectedTags()));
		assertFalse(CollectionUtils.valueExists("name", "two",  tagController.getSelectedTags()));
		assertTrue(CollectionUtils.valueExists ("name", "three",tagController.getSelectedTags()));
	...
	public void testAlreadyOwned() {
		...
		assertFalse(CollectionUtils.valueExists ("name", "one",  tagController.getSelectedTags()));
		assertTrue(CollectionUtils.valueExists("name", "two",  tagController.getSelectedTags()));
		assertFalse(CollectionUtils.valueExists ("name", "three",tagController.getSelectedTags()));
