...
public abstract class AbstractTransactionalSpringContextTests extends AbstractDependencyInjectionSpringContextTests {
	...
	@org.testng.annotations.Configuration(beforeTestMethod = true, groups = { "SpringContext" })
	 ...
	 */
	@SuppressWarnings("deprecation")
	@org.testng.annotations.Configuration(afterTestMethod = true, groups = { "SpringContext" })
