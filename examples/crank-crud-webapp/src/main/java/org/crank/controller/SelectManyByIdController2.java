...
public abstract class SelectManyByIdController2<PT extends Serializable, T extends Serializable, PK extends Serializable> {
	...
	public SelectManyByIdController2() {
		super();
	}
