...
public class JpaUtils {
	...
	/* commit and close. */
	public static void commitTransactionAndCloseEntityManager () throws Exception {
		joinedTransactionInProgress.set(false);
		EntityManager entityManager = entityManagerHolder.get();
		EntityTransaction transaction = transactionHolder.get();
	...
	public static void createEntityManagerAndStartTransaction() throws Exception {
		getOrCreateTransaction(getOrCreateEntityManager());
	}
