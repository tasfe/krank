...
public class InheritanceRelationshipsTest extends TestCase {

	//TODO Finish this method using the JPA skills from first labs.
	public void testRelationship() throws Exception {
		//TODO Write 10 groups to the database. 
		//TODO Write 10 users to the database.
		//TODO Query select subject from InSubject subject, 
		//TODO Ensure that both groups and users are written to the database.
	}
	...
	private void deleteRoles() throws Exception {
		...
		execute(new TransactionTemplate() {
			public Object execute() {
				...
				entityManager.createQuery("delete InRole").executeUpdate();
		...
		Group loadedGroup = (Group) execute(new TransactionTemplate() {
			...
			public Object execute() {
				...
				return (Group) entityManager.createNamedQuery(
						"in.loadGroup").setParameter("name", "sysadmins")
						.getSingleResult();
