...
@DependsOnJSF
@NeedsRefactoring("Remove dependency on JSF. " +
		" You will need to create a listener for crank")
public class JSFSpringApplicationContextObjectRegistry implements ObjectRegistry {
	...
	private void initIfNeeded() {
		if (applicationContext==null) {
			//fix this to remove the dependency on JSF.
			applicationContext = JSFSpringApplicationContextFinder.getApplicationContext();
		}
	}
