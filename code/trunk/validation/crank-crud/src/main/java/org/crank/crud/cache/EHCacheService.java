...
public class EHCacheService implements CacheService {
    ...
    private Cache createEHCacheWithConfiguration(CacheConfiguration crankCacheConfiguration) {
        Cache cache = new Cache(
                ...
                getMemoryStoreEvictionPolicy( crankCacheConfiguration),
                crankCacheConfiguration.isOverflowToDisk(),
                "",
                crankCacheConfiguration.isEternal(),
                crankCacheConfiguration.getTimeToLiveSeconds(),
                crankCacheConfiguration.getTimeToIdleSeconds(),
                crankCacheConfiguration.isDiskPersistent(),
                crankCacheConfiguration.getDiskExpiryThreadIntervalSeconds(),
                null
        );
        return cache;
    }
